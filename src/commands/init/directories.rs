...
use crate::paths::{
    ...
    foc_localnet_docker_volumes, foc_localnet_genesis, foc_localnet_genesis_sectors,
    foc_localnet_home, foc_localnet_logs, foc_localnet_lotus_keys, foc_localnet_proof_parameters,
